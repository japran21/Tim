...
<body>
  ...
  <div class="form-container">
    <div class="form-card">
      <h1 class="form-title">Edit Kategori Topping</h1>
      ...
      <form method="POST" action="">
        <div class="form-group">
          ...
          <input type="text" id="nama_topping" name="nama_topping"
            value="<?= htmlspecialchars($topping['nama_topping']) ?>" required>
        </div>
      ...
      <div class="info-card">
        ℹ️ <strong>Informasi:</strong> Perubahan nama topping akan langsung terlihat pada semua produk yang menggunakan
        topping ini karena menggunakan relasi antar tabel.
      </div>
    </div>
  </div>
</body>
